...
const COMMON_PASSWORDS: string[] = Array.from(new Set([
  // FROM: factory-default.lit
  'admin',
  'password',
  '0000',
  '12345',
...
const COMMON_DOG_NAMES = Array.from(new Set([
