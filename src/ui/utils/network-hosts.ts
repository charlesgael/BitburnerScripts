 ...
 * (`ui/apps/file-explorer.tsx`) to offer scanned/hacked hosts as browsable
 ...
 * itself — see `ui/apps/cloud-servers.tsx`'s header comment for why that
 ...
 * and only on whichever host they ran it on (see `ui/apps/task-manager.tsx`'s
