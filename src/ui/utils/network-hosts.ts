...
/**
 * Reads `netmapper.app.ts`'s cached network scan (`known-servers.json`)
 ...
 * `known-servers.json` only exists once the player has actually run
 ...
 */
const KNOWN_SERVERS_FILE = 'known-servers.json'
